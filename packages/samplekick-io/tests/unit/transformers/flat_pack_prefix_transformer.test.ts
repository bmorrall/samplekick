...
describe("createFlatPackPrefixTransformer", () => {
  describe("happy path", () => {
    it("sets packageName to the shared prefix and sampleType to Packs", () => {
      ...
      createFlatPackPrefixTransformer.transform(createFlatPackSource(dir, [c1, c2]));
    ...
    it("also renames non-audio files that carry the prefix", () => {
      ...
      createFlatPackPrefixTransformer.transform(createFlatPackSource(dir, [c1, c2, c3]));
  ...
  describe("does not act", () => {
    ...
    it("does not act when any child is a sub-directory (non-flat)", () => {
      ...
      createFlatPackPrefixTransformer.transform(createFlatPackSource(dir, [subDirWithChild, c1]));
    ...
    it("does not act when the entry has a parent (non-root)", () => {
      ...
      createFlatPackPrefixTransformer.transform(createFlatPackSource(nonRootDir, [c1, c2]));
