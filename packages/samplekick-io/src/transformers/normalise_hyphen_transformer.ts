...
const _singleton: Transform = createSanitiseNameTransformer(normaliseHyphenSpacing);
export const createNormaliseHyphenSpacingTransformer = (): Transform => _singleton;
